...
/**
 * Parameter-name keys for the RunMavenTestsTool MCP tool, shared between its schema() definition and handle() argument
...
public enum RunMavenTestsParamEnum {
    ...
    RunMavenTestsParamEnum(McpToolPropertyEnum property) {
