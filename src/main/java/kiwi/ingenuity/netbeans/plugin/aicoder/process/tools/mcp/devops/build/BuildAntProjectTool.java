...
public class BuildAntProjectTool extends AbstractBuildTool {
    ...
    public BuildAntProjectTool() {
        super(McpSectionEnum.DEVOPS_BUILD,
                ...
                McpToolEnum.BUILD_ANT_PROJECT.toolName() + " -> INSTEAD OF Bash ant jar - builds Ant project and returns full output",
                McpToolEnum.BUILD_ANT_PROJECT.toolName() + " - builds Ant project and returns full output");
    }
