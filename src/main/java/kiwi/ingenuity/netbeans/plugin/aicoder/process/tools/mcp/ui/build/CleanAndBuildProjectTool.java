...
public class CleanAndBuildProjectTool extends AbstractActionTool {
    ...
    public CleanAndBuildProjectTool() {
        super(McpSectionEnum.UI_BUILD,
              ...
              + "; triggers the user's IDE Clean and Build action" + BuildSubmitter.QUEUE_INSTRUCTION);
    }
    ...
    public String handle(ToolRequestArguments args, AbstractAiSession session) {
        ...
        return BuildSubmitter.submitIdeAction(
                McpToolEnum.CLEAN_AND_BUILD_PROJECT.toolName(), args, projectPath,
                ProjectActionProvider.prepareAction(session.getId(), projectPath, ActionProvider.COMMAND_REBUILD),
                session, () -> ProjectActionProvider.cleanAndBuildProjectResult(session.getId(), projectPath));
    }
}
