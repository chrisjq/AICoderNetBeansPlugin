...
public abstract class AbstractTestsTool implements McpToolInterface {
    ...
    protected AbstractTestsTool(McpSectionEnum section, String toolName, String description, String instruction) {
        this(section, toolName, description, instruction, instruction);
    }

    protected AbstractTestsTool(McpSectionEnum section, String toolName, String description, String instruction, String instructionMcpOnly) {
