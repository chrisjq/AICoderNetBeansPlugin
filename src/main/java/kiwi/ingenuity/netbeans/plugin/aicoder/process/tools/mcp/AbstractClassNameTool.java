...
public abstract class AbstractClassNameTool implements McpToolInterface {
    ...
    protected AbstractClassNameTool(McpSectionEnum section, String toolName, String description, String instruction) {
        this(section, toolName, description, instruction, instruction);
    }

    protected AbstractClassNameTool(McpSectionEnum section, String toolName, String description, String instruction, String instructionMcpOnly) {
    ...
    public JsonObject schema(Set<McpInstructionOptionEnum> options) {
        ...
        required.add(McpToolPropertyEnum.CLASS_NAME.key());
