...
public class CleanAndBuildMavenProjectTool extends AbstractBuildTool {
    ...
    public CleanAndBuildMavenProjectTool() {
        super(McpSectionEnum.DEVOPS_BUILD,
                ...
                McpToolEnum.CLEAN_AND_BUILD_MAVEN_PROJECT.toolName() + " -> INSTEAD OF Bash mvn clean package - cleans and builds Maven project and returns full output",
                McpToolEnum.CLEAN_AND_BUILD_MAVEN_PROJECT.toolName() + " - cleans and builds Maven project and returns full output");
    }
